...
export function HeroGridCard({ hero }: Props) {
  const {
    image,
    alias,
    status,
    ...
    <Card
      ...
      <div className="relative h-64">
        ...
        <div className="absolute top-3 left-3 flex items-center gap-2">
          <div className={cn(status === 'Active' ? 'bg-green-500' : 'bg-red-500', "w-3 h-3 rounded-full")} />
        ...
        <Button
          ...
          <Heart className={`h-4 w-4 text-red-500 ${isFavorite(hero) ? 'fill-red-500' : ''}`} />
        </Button>
      ...
      <CardHeader
        onClick={handleClick}
        className="cursor-pointer py-3 z-10 bg-gray-100/50 backdrop-blur-sm relative top-1 group-hover:top-[-10px] transition-all duration-300">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress activeColor="bg-orange-500" value={strength * 10} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress activeColor="bg-blue-500" value={intelligence * 10} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress activeColor="bg-green-500" value={speed * 10} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress activeColor="bg-purple-500" value={durability * 10} className="h-2" />
          </div>
        </div>
